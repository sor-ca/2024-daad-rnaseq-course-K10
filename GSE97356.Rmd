...
res_ashr_cn <- results(dds, contrast = c("Sample_group", "current", "never"))
...
#hist(res_shrink$log2FoldChange, 100)
```
```{r, fig.width = 10, fig.height = 10}
...
volcano_df <- res_ashr_cn %>% as.data.frame()
